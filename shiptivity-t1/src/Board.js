...
export default class Board extends React.Component {
  ...
  componentDidMount() {
    ...
    this.drake.on("drop", (el, target, source, sibling) =>
      this.updateView(el, target, source, sibling)
    );
  }

  updateView(el, target, source, sibling) {
    ...
    updatedClients.splice(index === -1 ? updatedClients.length : index, 0, {
      ...clientMove,
